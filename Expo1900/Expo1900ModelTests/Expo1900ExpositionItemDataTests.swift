//
//  Expo1900ExpositionItemDataTests.swift
//  Expo1900ModelTests
//
...
final class Expo1900ExpositionItemDataTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        sut = try decorder.decode([ExpositionItemData].self, from: itemsData.data).first
    }
    ...
    func test_ExpositionItemData에서_json_파일_내용이_제대로_디코딩된다() {
        // given
        let mock = ExpositionItemData.init(name: "직지심체요절",
                                           imageName: "jikji",
