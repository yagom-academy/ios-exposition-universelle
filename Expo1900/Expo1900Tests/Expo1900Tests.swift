...
final class Expo1900Tests: XCTestCase {
    ...
    func test_만국박람회_메인페이지_디코더_확인() {
        guard let assetData = NSDataAsset(name: "exposition_universelle_1900") else {
            XCTAssert(false)
            return
        }
        do {
    ...
    func test_만국박람회_한국출품작_디코더_확인() {
        guard let assetData = NSDataAsset(name: "items") else {
            XCTAssert(false)
            return
        }
